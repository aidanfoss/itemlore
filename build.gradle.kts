...
loom {
    ...
    accessWidenerPath = rootProject.file("src/main/resources/itemlore.accesswidener")
...
fabricApi {
    configureTests {
        ...
        enableClientGameTests = false // Default is true
